...
import '../homepage/Homepage.css'; // Reusing Homepage styles
import './About.css'; // New styles for About-specific content
import Lanyard from '../../components/Lanyard'; // Importing Lanyard component
...
const About = () => {
  ...
  const aiContext = useMemo(() => {
    return {
      currentPage: 'about',
      aboutData: readme || 'Loading README...',
  ...
  const handleAIResponse = useCallback((response) => {
    console.log('🤖 AI Response on About:', response);
  }, []);
